...
def main(params):
  ...
  with open('../data/splits/val2014.ids') as f:
    i = 0
    for line in f:
        img_id = int(line.strip())
        jimg = {}
        jimg['split'] = 'val2014'
        jimg['id'] = img_id# copy over & mantain an id, if present (e.g. coco ids, useful)
        out['images'].append(jimg)
       
        # load the image
        I = imread('../data/val2014/COCO_val2014_%012d.jpg'%(img_id))
        try:
